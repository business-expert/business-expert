...
Wide Domain Expertise: My expertise spans various domains including web applications, mobile apps, E-Commerce, CMS, API (REST/GraphQL), contact centers, Click2call, IVR, IP PBX, predictive dialer, CPAAS/UCAAS, workflow, headless architecture, and PWA technology enhancements.
...
Completed Master of Computer Application (MCA) from IGNOU.
Attained an MBA in System and Marketing from SMU.
Earned an MSc in Mathematics from DSB Campus Nainital.
Achieved a B.Sc in Statistics with specializations in Mathematics and Physics from DSB Campus Nainital.
Received a Google Project Management certificate.
Recognized as a Google Certified Data Analyst.
Completed Udemy courses in R language and Machine Learning
Udemy Course for TensorFlow/Python
...
Aiclub.com.hk: Orchestrated the development of a custom PHP MVC-based platform housing multiple role-oriented systems for user and task management.
Dragonusaonline: Undertook a comprehensive overhaul of this project, transitioning it from a Classic ASP-based website to a robust ASP.NET, C#, HTML5/CSS3, and SQL architecture, resulting in enhanced server performance.
Panda Dental Software: Managed the development of various modules for this dental software, leveraging ASP.NET, C#, and SQL Server technologies.
TTWA.it: Successfully coordinated the creation of a travel booking system for hotels, coupled with a police verification component.
Hotel Delivery Management System: Oversaw the design and implementation of a system facilitating hotel food delivery, encompassing order tracking capabilities.
...
Crocrm.info: Directed the creation of a comprehensive CRM system tailored to insurance companies, utilizing ASP.NET, SQL Server, and C#. The system catered to handling new leads and included an account management component.
Lettermail: Managed the conception and execution of a sophisticated mail management system, enabling the delivery of physical mail to users' residences, with complete backend administration and user dashboard management.
